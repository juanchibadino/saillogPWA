...
type TeamStandardMovesToolbarOption = {
  label: string
  value: string
  href: string
  count?: number
...
export function TeamStandardMovesToolbar({
  options,
  selectedValue,
  disabled = false,
  isNavigating = false,
  ...
  options: TeamStandardMovesToolbarOption[]
  ...
  function navigateToOption(option: TeamStandardMovesToolbarOption): void {
    ...
    <section className="flex w-full items-center justify-end gap-2">
      <Drawer open={isFilterDrawerOpen} onOpenChange={setIsFilterDrawerOpen}>
        <button
          type="button"
          disabled={isDisabled}
          aria-label="Filter standard moves by status"
        ...
        <DrawerContent className="flex max-h-[85dvh] flex-col gap-0 overflow-hidden">
          <DrawerHeader className="shrink-0 border-b text-left">
            ...
            <DrawerDescription>Filter standard moves by active state.</DrawerDescription>
          </DrawerHeader>
