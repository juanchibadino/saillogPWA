...
export function StandardMovesResultsRetry({
  message = "Could not load standard move results.",
}: {
  message?: string
}) {
    ...
    >
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          <h2 className="text-base font-semibold">Standard move results unavailable</h2>
