...
function AssetThumbnail(input: {
  ...
  if (isImage && input.asset.signedUrl && !hasImageError) {
    return (
...
function AssetCard(input: {
  ...
  return (
    <Dialog>
      <div className="group relative overflow-hidden rounded-lg border bg-card shadow-sm transition-colors hover:bg-muted/40">
        <DialogTrigger
          render={
            <button
              type="button"
...
function SessionAssetsPanel(input: {
  title: string
  description: string
  emptyMessage: string
  sessionId: string
    ...
    >
      ...
      <section className="rounded-xl border bg-card p-4 sm:p-6">
        ...
        <TabsContent value="images" className="space-y-4">
          <SessionAssetsPanel
            title="Images"
            description="Photos from training or regatta sessions."
            sessionId={input.sessionId}
            scope={input.scope}
            assetType="photo"
            tab="images"
        ...
        <TabsContent value="analytics" className="space-y-4">
          <SessionAssetsPanel
            title="Analytics"
            description="Analytics PDFs provided by the analytics team."
            sessionId={input.sessionId}
            scope={input.scope}
