...
export function resolveTeamWindPatternStatusFilter(value) {
  if (value === "archived") {
    return "archived"
  }
...
export function resolveTeamWindPatternsListRequest(input) {
  return {
    requestedStatusFilter: resolveTeamWindPatternStatusFilter(
...
export function resolveTeamWindPatternsPagination(input) {
...
export function buildTeamWindPatternsPageHref(input) {
...
export function buildTeamWindPatternsRedirectPath(input) {
  ...
  return query.length > 0 ? `/team-wind-patterns?${query}` : "/team-wind-patterns"
}
