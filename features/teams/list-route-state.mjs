...
export function resolveTeamsListRequest(input) {
  return {
...
export function resolveTeamsPagination(input) {
...
export function buildTeamsPageHref(input) {
...
export function buildTeamsRedirectPath(input) {
