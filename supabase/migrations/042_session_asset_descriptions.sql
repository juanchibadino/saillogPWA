-- 042_session_asset_descriptions.sql
-- Optional descriptions for session asset uploads.

alter table public.session_assets
  add column if not exists description text;

alter table public.session_assets
  drop constraint if exists session_assets_description_length_check;

alter table public.session_assets
  add constraint session_assets_description_length_check
  check (
    description is null
